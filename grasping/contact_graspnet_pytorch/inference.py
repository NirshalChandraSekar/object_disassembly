...
if __name__ == "__main__":
    ...
    global_config = config_utils.load_config("grasping/checkpoints/contact_graspnet", batch_size=FLAGS.forward_passes, arg_configs=FLAGS.arg_configs)
...
#         self.global_config = config_utils.load_config('grasping/checkpoints/contact_graspnet')
#         self.ckpt_dir = 'grasping/checkpoints/contact_graspnet'
...
#         # model_checkpoint_dir = "checkpoints/contact_graspnet/checkpoints"
#         checkpoint_io = CheckpointIO(checkpoint_dir=model_checkpoint_dir, model=grasp_estimator.model)
#         try:
#             load_dict = checkpoint_io.load('model.pt')
#         except FileExistsError:
